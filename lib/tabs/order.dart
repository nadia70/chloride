...
class FourthTab extends StatefulWidget {
  ...
  FourthTab({Key key, this.toolbarname}) : super(key: key);
...
class oder_history extends State<FourthTab> {
  List list = ['12', '11'];
  ...
  List<Item> itemList = <Item>[
    Item(
        ...
        oderAmount: '\₹ 650',
        paymentType: 'online',
        address: '1338 Karen Lane,Nairobi',
    ...
    Item(
        ...
        oderAmount: '\₹ 250',
        paymentType: 'online',
        address: '92 Jarvis Street,nairobi',
        cancelOder: 'View Receipt'),
    Item(
        name: 'Miller Root',
        ...
        address: '103 Romrog Way,nairobi',
        cancelOder: 'Cancel Order'),
    Item(
        name: 'Lag Gilli',
  ...
  Widget _status(status) {
    if(status == 'Cancel Order'){
      ...
      return FlatButton.icon(
          label: Text(status,style: TextStyle(color: Colors.indigo),),
          icon: const Icon(Icons.check_circle, size: 18.0,color: Colors.indigo,),
          onPressed: () {
            // Perform some action
          }
      );
