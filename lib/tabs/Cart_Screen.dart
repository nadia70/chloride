...
import 'package:chloride_app/tabs/checkout_screen.dart';
...
class Cart extends State<Cart_screen> {
  List<Item> itemList = <Item>[
    Item(
        itemImage: 'assets/images/power.png',
        itemName: 'POWERLAST MF',
        itemQun: 'Qty:1',
        itemPrice: '\₹ 100'),
    Item(
        itemImage: 'assets/images/spark.png',
        itemName: 'SPARK MF',
        itemQun: 'Qty:3',
        itemPrice: '\₹ 112'),
    Item(
        itemImage: 'assets/images/max.png',
        itemName: 'MAXX MF',
        itemQun: 'Qty:3',
        itemPrice: '\₹ 100'),
    Item(
        itemImage: 'assets/images/imported.png',
        itemName: 'IMPORT MF',
        itemQun: 'Qty:3',
        itemPrice: '\₹ 112'),
