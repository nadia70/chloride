...
import 'package:chloride_app/tabs/Item.dart';
import 'package:chloride_app/tabs/GetRatings.dart';
import 'package:chloride_app/tabs/GridItemDetails.dart';
      ...
      child: Card(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            new Padding(
              padding: EdgeInsets.fromLTRB(4.0, 5.0, 4.0, 2.0),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  Text(
